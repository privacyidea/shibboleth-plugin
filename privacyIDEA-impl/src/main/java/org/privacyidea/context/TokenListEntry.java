...
public final class TokenListEntry
{
    ...
    public TokenListEntry(String serial, String type, String description, String lastUsed,
                          boolean active, boolean revoked, boolean locked, String rolloutState)
    {
    ...
    /** @return the last-used timestamp (raw, as privacyIDEA reports it), or empty if the token was never used. */
